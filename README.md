...
- error.py: app lib exception defintions
2. logs: customer churn library functions log file, test logging is done directly in the console (see running files below)
